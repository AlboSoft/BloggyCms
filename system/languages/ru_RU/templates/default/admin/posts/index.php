...
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_DATE_LABEL', 'Дата создания');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_MODE_LABEL', 'Режим выбора');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_MODE_DAY', 'День');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_MODE_PERIOD', 'Период');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_DATE_FROM', 'От даты');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_CREATE_DATE_TO', 'До даты');
define('LANG_TEMPLATE_POSTS_INDEX_FILTER_APPLY_BTN', 'Фильтр');
