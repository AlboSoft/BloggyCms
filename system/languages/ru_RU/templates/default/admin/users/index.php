...
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_DATE_LABEL', 'Дата регистрации');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_MODE_LABEL', 'Режим выбора');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_MODE_DAY', 'День');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_MODE_PERIOD', 'Период');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_DATE_FROM', 'От даты');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_REG_DATE_TO', 'До даты');
define('LANG_TEMPLATE_USERS_INDEX_FILTER_APPLY_BTN', 'Фильтр');
