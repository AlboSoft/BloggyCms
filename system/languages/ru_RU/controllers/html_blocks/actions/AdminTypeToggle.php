...
define('LANG_ACTION_HTMLBLOCKS_ADMINTYPETOGGLE_DISABLED', 'отключен');
define('LANG_ACTION_HTMLBLOCKS_ADMINTYPETOGGLE_SUCCESS', 'Тип блока успешно %s');
define('LANG_ACTION_HTMLBLOCKS_ADMINTYPETOGGLE_ERROR', 'Ошибка при изменении статуса типа блока: ');