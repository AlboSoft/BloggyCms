...
define('LANG_ACTION_DEBUG_ADMINTOGGLE_ON', 'Режим отладки включен');
define('LANG_ACTION_DEBUG_ADMINTOGGLE_OFF', 'Режим отладки выключен');
define('LANG_ACTION_DEBUG_ADMINTOGGLE_ERROR', 'Ошибка при изменении состояния');