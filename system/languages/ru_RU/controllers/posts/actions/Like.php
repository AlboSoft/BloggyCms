...
define('LANG_ACTION_POSTS_LIKE_POST_NOT_FOUND', 'Пост не найден');
define('LANG_ACTION_POSTS_LIKE_ADDED', 'Пост добавлен в избранное');
define('LANG_ACTION_POSTS_LIKE_REMOVED', 'Пост удален из избранного');