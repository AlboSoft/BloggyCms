...
define('LANG_ACTION_SETTINGS_BASE_DEFAULT_SEARCH_H1', 'Поиск по сайту');
define('LANG_ACTION_SETTINGS_BASE_DEFAULT_SEARCH_TITLE', 'Поиск по запросу: ');
define('LANG_ACTION_SETTINGS_BASE_CONFIG_NOT_WRITABLE', 'Конфигурационный файл недоступен для записи');