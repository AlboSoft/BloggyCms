...
define('LANG_ACTION_SEO_ADMINTESTINDEXNOW_UNKNOWN_ERROR', 'Unknown error');
define('LANG_ACTION_SEO_ADMINTESTINDEXNOW_SUCCESS', 'IndexNow test: ');
define('LANG_ACTION_SEO_ADMINTESTINDEXNOW_FAILURE', 'IndexNow test: ');
define('LANG_ACTION_SEO_ADMINTESTINDEXNOW_EXCEPTION', 'IndexNow test error: %s');