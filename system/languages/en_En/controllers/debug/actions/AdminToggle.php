...
define('LANG_ACTION_DEBUG_ADMINTOGGLE_ON', 'Debug mode enabled');
define('LANG_ACTION_DEBUG_ADMINTOGGLE_OFF', 'Debug mode disabled');
define('LANG_ACTION_DEBUG_ADMINTOGGLE_ERROR', 'Error changing state');