...
define('LANG_ACTION_SETTINGS_BASE_DEFAULT_SEARCH_H1', 'Site Search');
define('LANG_ACTION_SETTINGS_BASE_DEFAULT_SEARCH_TITLE', 'Search for: ');
define('LANG_ACTION_SETTINGS_BASE_CONFIG_NOT_WRITABLE', 'Configuration file is not writable');